...
(function (window, undefined) {
	...
	function calc(title, inputpl, inputpla){
		var l = {m:1150000, q:300, f:0.0035525, p:"201607"},
		pl 
//		= {
//			"201707" : { m:200000, f:0.03, t:0 }
//			,"201807" : { m:20000, f:0.02, t:0 }
//			,"201907" : { m:20000, f:0.01, t:0 }
//			,"202007" : { m:20000, f:0, t:0 }
//			,"202107" : { m:20000, f:0, t:0 }
//			,"202207" : { m:25000, f:0, t:0 }
//			,"202307" : { m:25000, f:0, t:0 }
//			,"202407" : { m:25000, f:0, t:0 }
//			,"202507" : { m:25000, f:0, t:0 }
//			,"202607" : { m:25000, f:0, t:0 }
//			,"202707" : { m:30000, f:0, t:1 }
//			,"202807" : { m:30000, f:0, t:1 }
//			,"202907" : { m:30000, f:0, t:1 }
//		}
	,
		pla 
//		= [
					...
					if(recalc) {
						...
						if(dqdate == tqdate) {
							if(tq.t == 1) {
								...
								sydk = +lastdic["计息剩余贷款"];
								sydk = sydk - (tq.m * (1 - tq.f));
								year = mdic["还款日期"].substr(0, 4);
								month = mdic["还款日期"].substr(4, 2);
